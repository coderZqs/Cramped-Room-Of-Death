...
let BASE_URL = 'texture/door/idle/'
...
class IdleSubStateManager extends DirectionSubStateMachine {
  constructor(fsm: StateMachine) {
    ...
    this.stateMachine.set(DIRECTION_ENUM.BOTTOM, new State(fsm, BASE_URL + 'top', AnimationClip.WrapMode.Normal))
    this.stateMachine.set(DIRECTION_ENUM.RIGHT, new State(fsm, BASE_URL + 'left', AnimationClip.WrapMode.Normal))
  }
}
